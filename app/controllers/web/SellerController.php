...
class SellerController {
    ...
    public function regenerateApiKey() {
        ...
        if (APP_ENV === 'development') {
            ...
            error_log('New Webhook Secret: ' . $newWebhookSecret);
        ...
        if (APP_ENV === 'development') {
            ...
            error_log('Verified Webhook Secret in DB: ' . substr($verifyUpdate['webhook_secret'], 0, 16) . '...');
        ...
        $_SESSION['new_webhook_secret'] = $newWebhookSecret;
        $_SESSION['success'] = 'Novas credenciais geradas com sucesso! Anote todas as credenciais, elas não serão mostradas novamente.';
